...
<div id="overlay"></div>
    <div id="popup">
        ...
        <form id="income" action="expensestable.php" method="POST">
            ...
            <input type="text" name="itembought" id="itemsold" required>
            ...
            <input type="text" name="buyfrom" id="soldto" required>

            <button type="submit" name="updates">Submit</button>
        </form>
    </div>   
    </div>   
    ...
    <div class="maincontainer">
        ...
        ?>
                <tr>
                    ...
                    <td><?php echo $row['buyfrom']?></td>
                    <td class="button-container">
                    <button class="edit-btn" onclick="editRow()">Edit</button>
                    <form id="flockForm" method="POST" action="expensestable.php">    
                        <?php 
                            if (isset($_POST["deleteID"])) {
                                $deleteid = $_POST["deleteID"];
                                $deleteSql = "DELETE FROM expenses WHERE id = '$deleteid'";
                        ...
                        <a href="expenses.php"><button class="view-btn" onclick="viewRow(this)">View</button></a>
                    </td>
                </tr>
