...
if(isset($_POST['submits'])){
    ...
    $sql = "INSERT INTO expenses (flocks,	date,	itembought, qty, amount, mop,	pstatus,	buyfrom	) 
    VALUES ('$flockName', '$flockDate', '$itembought', '$qty', '$amount', '$mop', '$pstatus', '$buyfrom')";
...
<button class="edit-btn" onclick="editRow()">EXPENSES</button>

<div id="overlay"></div>
    <div id="popup">
        <h2>Flock Information</h2>
        <form id="flockForm" action="expenses.php" method="POST">
            ...
            <input type="text" name="itembought" id="itembought" required>
            ...
            <label for="source">Buy From:</label>
            <input type="text" name="buyfrom" id="buyfrom" required>
    ...
    ?>
        <a href="#">
            <div class="cat-info">
                ...
                <p><strong>Bought From:</strong> <?php echo $row['buyfrom']?></p>
                <p><strong>Item Bought:</strong> <?php echo $row['itembought']?></p>
